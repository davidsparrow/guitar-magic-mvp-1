...
async function runDatabaseIntegrationTests() {
  ...
  try {
    ...
    const { createCompleteSong } = await import('../utils/songDatabaseUG.js')
    ...
    if (storeResult.success) {
      ...
      const { getSongWithStructure } = await import('../utils/songDatabaseUG.js')
  ...
  try {
    const { searchSongs } = await import('../utils/songDatabaseUG.js')
  ...
  try {
    const { getSongByUGTabId } = await import('../utils/songDatabaseUG.js')
